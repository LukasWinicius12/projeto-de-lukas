...
<head>
    ...
    <title>Meu portfólio da aula 10</title>
</head>

<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar de Lukas" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou o Lukas_</p>
